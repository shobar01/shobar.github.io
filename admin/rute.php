...
if (@$_SESSION['username']){
 if  (@$_SESSION['id_rute']=="Admin"){header("location:../admin");}
  else {
    if (@$_SESSION['id_rute']=="Kasir"){header("location:../kasir");}
    else if (@$_SESSION['id_rute']=="Dokter"){header("location:../dokter");}
    else if (@$_SESSION['id_rute']=="Pendaftar"){header("location:../Pendaftar");}
  }
