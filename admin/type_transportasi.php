...
if (@$_SESSION['username']){
 if  (@$_SESSION['id_type_transportasi']=="Admin"){header("location:../admin");}
  else {
    if (@$_SESSION['id_type_transportasi']=="Kasir"){header("location:../kasir");}
    else if (@$_SESSION['id_type_transportasi']=="Dokter"){header("location:../dokter");}
    else if (@$_SESSION['id_type_transportasi']=="Pendaftar"){header("location:../Pendaftar");}
  }
