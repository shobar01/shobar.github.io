...
if (@$_SESSION['username']){
 if  (@$_SESSION['id_penumpang']=="Admin"){header("location:../admin");}
  else {
    if (@$_SESSION['id_penumpang']=="Kasir"){header("location:../kasir");}
    else if (@$_SESSION['id_penumpang']=="Dokter"){header("location:../dokter");}
    else if (@$_SESSION['id_penumpang']=="Pendaftar"){header("location:../Pendaftar");}
  }
