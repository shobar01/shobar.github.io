...
<head>
    ...
    <title>Penumpang Dashboard</title>
  <!-- BOOTSTRAP STYLES-->
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="pegawai.php?page=pegawai"></i><font color="black">Data Pemesanan </font></a>
                    </li>
                    <li>
                        <a href="jadwal.php?page=jadwal"><font color="black">Data Pembayaran </font></a>
                    </li>
                ...
                <div class="row">
                    <div class="col-lg-12 ">
                        <div class="alert alert-info">
                             ...
                             <br>
                             <h4><strong>Penumpang Shobar Nuryana</strong></h4>
                           </br>
                        </div>
